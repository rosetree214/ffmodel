...
def run_simulation(players: List[Player], settings: SimulationRequest = None) -> Dict[str, Any]:
    ...
    logger.info(f"Running simulation for {len(players)} players with {settings.num_simulations} iterations")
...
def run_optimized_simulation(players: List[Player], settings: SimulationRequest = None) -> Dict[str, Any]:
